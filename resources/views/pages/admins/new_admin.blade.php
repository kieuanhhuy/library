...
<!-- Title -->
<title>{{__('Registracija novog administratora | Online biblioteka')}}</title>
...
<section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
    ...
    <div class="scroll height-content section-content">
        <form class="text-gray-700 text-[14px]" method="POST"
              action="{{route('store-admin')}}" enctype="multipart/form-data">
            @csrf @honeypot
                ...
                <div class="w-[50%] mb-[100px]">
                    <div class="mt-[20px]">
                        ...
                        <input
                                ...
                                onkeydown="clearErrorsNameBibliotekar()"
                                value="{{old('name')}}"/>
                    </div>
                    ...
                    <div class="mt-[20px]">
                        ...
                        <span>
                            ...
                            <span
                                    style="cursor: help"
                                    data-tooltip-content="Školski email je email koji u sebi sadrži domen škole. Primjer: @mail.com"
            ...
            <div class="absolute bottom-0 w-full">
                <div class="flex flex-row">
                    <div class="inline-block w-full text-right py-[7px] mr-[100px] text-white">
                        <button
                                type="button"
                                onclick="location.href='{{ route('all-admin') }}'"
